...
```{r}
Under_five_deaths_win <- Winsorize(numeric_data$Under_five_deaths, minval = NULL, maxval = NULL, probs = c(0.01, 0.99), na.rm = TRUE, type = 1)
numeric_data$Under_five_deaths <- Under_five_deaths_win
```
...
num_outliers(df, df$Under_five_deaths)
num_outliers(numeric_data, numeric_data$Under_five_deaths)
