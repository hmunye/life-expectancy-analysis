...
# Train the model
XG_model <- xgb.train(params = params, data = dtrain, nrounds = nrounds, watchlist = list(train = dtrain, test = dtest), early_stopping_rounds = 10)
```
...
conf_matrix <- table(Predicted = predicted_labels, Actual = test_data$Economy_status_Developed)
print(conf_matrix) 
...
|--------------|-----------|---------|---------|
| Specificity  | 83.05%    | 66.67%  | 92.74%  |
| Sensitivity  | 91.5%     | 96.04%  | 81.11%  |
...
| Country       | GDP      | Population | Thinness | Schooling |
|---------------|----------|------------|----------|-----------|
| Tunisia       | 3585.63  | 10.39      | 6.41     | 6.11      |
| Algeria       | 3745.13  | 34.82      | 6.09     | 6.99      |
| Zimbabwe      | 1290.6   | 12.5       | 7.0      | 7.2       |
| Lesotho       | 926.69   | 2.01       | 7.19     | 5.52      |
| United States | 52662.94 | 302.10     | 0.73     | 13.01     |
