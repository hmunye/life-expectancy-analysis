...
2\) Fill in with mean/median/mode: For numerical colloumns, which all of are missing values are, it is possible to calcualte the mean, median, or mode of the dataset and replace the missing values with one them.
