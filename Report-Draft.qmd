...
Same as the 10-19 Thinness, Most of this graph is a mirrior of the other Thinness graph.
...
Schooling is our most evenly distrubted graph so far.
...
```{r}
confusionMatrix(factor(preds),factor())
```
...
Across almost all of our plots Africa is the lowest when it comes to life expectancy, and the highest when it comes to mortality. Why is that? We will be looking at Africa in depth in order to possibly explain why.
...
Next we will break down Africa into the countries within it for futher analysis, and examine each variable in our data set this way to look for possible explanations.
...
Tunisia and Algeria have lower mortality Rates comapred to Zimbabwe and Lesotho due to higher vaccination rates, higher GDP, and lower incidents of HIV.
