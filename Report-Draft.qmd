...
o (Use 3 different , MR, Forest, SVR, XG Boost, ANN (Not deep) )
...
o drinking alcohol, immunizations, etc.?
...
Why is there a spike in adult mortality rates around 150?
...
Possible questions: Why is there a large spike at 62%
...
Possible questions: Why are there two groups, one with a peak at 23 and one with a peak at 26?
...
Possible questions: Why is there a second peak around 7?
...
df |>
  ...
  geom_point() +
  geom_text(aes(label = paste("Covariance:", round(cov(Diphtheria, Infant_deaths), 2))),
            x = Inf, y = Inf, hjust = 1, vjust = 1, color = "black")
...
<<<<<<< HEAD
No attributes are evenly distributed.
...
#### 5.3 ????
>>>>>>> d73d3439ec52b353ef5058f40406fdebd44ccc1b
